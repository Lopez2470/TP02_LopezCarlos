package ar.edu.unju.fi.ejercicio5.util;
...
public class Listado {
	...
	/*	listadoProductos.add(new Producto("T001","Cargador",8500.,OrigenFabricacion.ARGENTINA,Categoria.TELEFONIA,false));
		...
		listadoProductos.add(new Producto("I010","Teclado + Mouse",15000.,OrigenFabricacion.URUGUAY,Categoria.INFORMATICA,true));
		...
		listadoProductos.add(new Producto("H002","Taladro",250000.,OrigenFabricacion.BRASIL,Categoria.ELECTROHOGAR,true));
